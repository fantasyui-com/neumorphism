...
3. It takes almost 5 seconds to wait for a code update to trigger a node-sass compilation and storybook rebuild/preview. It is extremely distracting. Furthermore, bootstrap code is tough, the new utilities/api is exhausting, using actual bootstrap code-base for design is a bad idea. A simple in-browser/in-app preview for neumorphic and neumorphic-like designs with a simple button that generates the _variables overload is a solution to a problem that many designers discover all too late in their tool-chain.
